...
def plot_smoothed(
    series_list, labels=None, title="", xlabel="Step", ylabel="Value", num_points=40
):
    """
...
def eval_performance(
    ...
    """Evaluate the performance of the agents in the environment over timesteps iterations/seconds.

    Args:
        num_agents: number of agents
        agent_controller: description of the agent controller
        env: description of the environment
        name: description of the evaluation run
        timesteps: number of timesteps to evaluate. Defaults to 5000.
        agents_list: list of agents to evaluate. Defaults to None.
        epsilon: exploration rate for the evaluation. Defaults to 0.1.
        collect_detailed_data: More data will be
