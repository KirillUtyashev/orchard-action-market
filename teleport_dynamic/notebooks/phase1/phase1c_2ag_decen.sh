...
if [ $IDX -lt 16 ]; then
    LEARNING="reward"
    MODEL_IDX=$IDX
    INPUT_NOTEBOOK="../Reward_Learning_Decentralized.ipynb"
else
    LEARNING="td0"
    MODEL_IDX=$((IDX - 16))
...
# EXECUTION
#=========================================================================================
EXPERIMENT_NAME="p1c_2ag_dec"
JOB_ID="${EXPERIMENT_NAME}_${LEARNING}_${DESC}"
OUTPUT_NOTEBOOK="output_notebooks/${JOB_ID}.ipynb"
REWARD_SCHEME="minus1_2"

echo "=== Phase 1C: 2 Agent Decentralized (minus1_2) ==="
echo "Job ID:     ${JOB_ID}"
