...
class ActorCriticPerfect(ActorCritic):
    def __init__(self, config: ExperimentConfig):
        ...
        self.actor_view_controller = ViewController(self.train_config.critic_vision)
        self.agent_controller = AgentControllerActorCritic(self.agents_list, self.critic_view_controller, self.critic_view_controller)
            ...
            for tick in range(self.train_config.num_agents):
                ...
                if action is not None:
                    for each_agent in range(len(self.agents_list)):
                        ...
                        processed_state = self.critic_view_controller.process_state(s, positions[each_agent])
                        processed_new_state = self.critic_view_controller.process_state(new_s, curr_pos)
