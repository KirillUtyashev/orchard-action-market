    ...
    def collect_observation(self, step: int) -> None:
        ...
        try:
            for tick in range(self.train_config.num_agents):
                ...
                processed_state: np.ndarray = self.critic_view_controller.process_state(
                    env_step_result.old_state,
                    env_step_result.old_positions[env_step_result.acting_agent_id],
                    None,
                )
                processed_new_state: np.ndarray = (
                ...
                self.agents_list[env_step_result.acting_agent_id].add_experience(
